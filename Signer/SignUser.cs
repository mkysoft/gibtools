...
{
    // TODO:
    //public class SignUser: ISignature
    public class SignUser
    {
        ...
        public SignUser(SignRequest request)
        {
            SignRequest = request;
            XmlData = request.XmlData;
        }

        public SignUser(SignRequest request, string _XmlData)
        {
            XmlData = _XmlData.ToByteArray();
            SignRequest = request;
            SignRequest.XmlData = XmlData;
        }

        public SignUser(SignRequest request, byte[] _XmlData)
        {
            XmlData = _XmlData;
            SignRequest = request;
            SignRequest.XmlData = XmlData;
        ...
        private async Task SignAsync()
        {
            ...
            //requestMessage = new HttpRequestMessage(HttpMethod.Post, new ESignConfiguration().ESignAPIUrl + "api/signer/signuser");
